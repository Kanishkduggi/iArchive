...
def download_website(url, output_dir):
    ...
    subdirectory = os.path.join(output_dir, page_title)
    if not os.path.exists(subdirectory):
        os.makedirs(subdirectory)

    html_filename = os.path.join(subdirectory, f"{page_title}.html")
    ...
    def download_resource(resource_url, folder_name):
        try:
            ...
            resource_path = os.path.join(subdirectory, folder_name, os.path.basename(resource_url))
    ...
    print(f"Website downloaded to {subdirectory}")
